    ...
    <div className="fixed inset-x-0 top-0 z-[100]">
      ...
      <header
        className={cn(
          ...
          isScrolled
            ? "bg-background/95 backdrop-blur-md shadow-md py-1.5 lg:py-1"
            : "bg-background py-2.5 lg:py-2"
        )}
      >
        ...
        <div className="container-custom">
          <nav className="flex items-center justify-between">
            ...
            <Link to="/" className="flex items-center gap-3 flex-shrink-0">
              <img src={logo} alt="CT Shop Logo" className="h-10 md:h-10 lg:h-12 w-auto" />
            </Link>
